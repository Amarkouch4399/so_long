...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/25 16:12:35 by ouamarko          #+#    #+#             */
/*   Updated: 2025/10/29 16:23:15 by ouamarko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/so_long.h"

static void	ft_free_split(char **split, size_t index)
{
	while (index > 0)
	{
		index--;
...
char	**ft_split(char const *s, char c)
{
	...
	{
		ft_free_split(split, nb_strings);
		return (free(split), NULL);
	}
	return (split);
}
